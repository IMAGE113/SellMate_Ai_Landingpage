      ...
      <section className="pt-28 pb-16 px-6 md:pt-40 md:pb-32 md:px-8">
        <div className="container mx-auto grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          <div className="space-y-8 text-center lg:text-left">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-md bg-blue-50 text-[#2563EB] text-[10px] md:text-[11px] font-bold tracking-wider uppercase mx-auto lg:mx-0">
              <Zap className="w-3 h-3" /> AI Infrastructure for Social Commerce
            </div>
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold text-[#0F172A] leading-[1.1] tracking-tight">
              Automate Sales.<br />
              <span className="text-[#2563EB]">Integrate Everything.</span>
            </h1>
          ...
          <div className="flex flex-col items-center">
            <div className="mb-8 text-center">
              <h2 className="text-2xl md:text-3xl font-bold text-[#0F172A]">Our Workflow</h2>
      ...
      <section id="solutions" className="py-20 md:py-24 container mx-auto px-6 md:px-8">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-6">
          {[
            ...
            <div key={i} className="group p-8 bg-white border border-slate-100 rounded-3xl hover:border-[#2563EB] transition-all shadow-sm hover:shadow-md">
              <div className="w-12 h-12 bg-slate-50 rounded-xl flex items-center justify-center mb-6 text-[#2563EB] group-hover:bg-[#2563EB] group-hover:text-white transition-all">
                {f.icon}
              </div>
        ...
        <div className="container mx-auto px-6 md:px-12 grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-6 md:space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm font-semibold">
              <div className="flex items-center gap-2 text-slate-300"><Check className="text-[#2563EB] w-5 h-5" /> 99.9% System Uptime</div>
              <div className="flex items-center gap-2 text-slate-300"><Check className="text-[#2563EB] w-5 h-5" /> Bank-grade Security</div>
              <div className="flex items-center gap-2 text-slate-300"><Check className="text-[#2563EB] w-5 h-5" /> Multi-carrier Sync</div>
              <div className="flex items-center gap-2 text-slate-300"><Check className="text-[#2563EB] w-5 h-5" /> Real-time Analytics</div>
            </div>
          </div>
