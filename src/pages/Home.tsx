      ...
      <nav className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-slate-100">
        <div className="container mx-auto flex items-center justify-between py-4 px-6 md:px-8">
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 md:w-9 md:h-9 bg-brandBlue rounded-xl flex items-center justify-center text-white shadow-md">
          ...
          <button className="bg-brandBlue text-white px-4 py-2 md:px-6 md:py-2.5 rounded-lg font-bold text-xs md:text-sm hover:bg-blue-700 transition">
            Request Beta
          </button>
        </div>
      </nav>
      ...
      <section className="pt-28 pb-16 px-6 md:pt-40 md:pb-32 md:px-8">
        <div className="container mx-auto grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          ...
          <div className="space-y-8 text-center lg:text-left">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold text-brandDark leading-[1.2] md:leading-[1.1] tracking-tight">
              Automate Sales.<br />
          ...
          <div className="flex flex-col items-center">
            <div className="mb-8 text-center">
              ...
              <p className="text-sm text-slate-400 mt-1">From Chat to Delivery</p>
            </div>
      ...
      <section id="infrastructure" className="py-20 md:py-24 bg-brandDark text-white overflow-hidden">
        <div className="container mx-auto px-6 md:px-12 grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-6 md:space-y-8">
            <h2 className="text-3xl md:text-5xl font-bold leading-tight">API-First Commerce Infrastructure.</h2>
